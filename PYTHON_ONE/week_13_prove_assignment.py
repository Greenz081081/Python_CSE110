...
def calculate_wind_chill(windChill):
...
# Display the wind chill value to 2 decimals of precision.
        print(f"At temperature {celsius_temperature}F, and wind speed {wind_speeds} mph, the windchill is: {calculate_wind_chill(celsius_temperature):.2f}")
